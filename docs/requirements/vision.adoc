...
Dieses Visions-Dokument bezieht sich auf das System Liefercolada, das vom Team 3 Promille entwickelt wird. Das System wird es dem barbesitzer in der Neustadt erlauben, unseren Onlineshop zu nutzen, um damit jeden auch während Pandemien zu erreichen / den Zugang zu den Cocktails zu erleichtern / eigene Kreationen zu ermöglichen.
...
[cols="1,3"]
|===
| Für | kleine Cocktailbar in der Neustadt
| der / die | Cocktails auch Online versenden möchte
| ist das  | Liefer Colada
| ein  | Onlineshop
| der / die | das Barfeeling für zu Hause bietet und den Kunden vor einer möglichen Pandemie absichert
...
| Kunde | Inhaber der kleinen Bar und er möchte seine Cocktails allen verfügbar machen und deshalb seine Cocktails auch außerhalb der Bar verkaufen | Gibt uns Vorgaben für den Seitenaufbau und finanziert unser Projekt
| Nutzer | will auch außerhalb der Bar seine Lieblingscocktails trinken und eigene Kreationen erstellen | soll nicht durch technische Probleme abgeschreckt werden; nutzt das System
| Gesetzgeber | nervt... | gibt Rahmenbedingungen; überprüft Datenschutz, Datensicherheit, AGBs
|===
